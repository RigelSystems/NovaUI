const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./NNotification-2j1akSL-.js","./iframe-Ba5HEGk7.js","./vue.esm-bundler-B7Tz_gfl.js","./_plugin-vue_export-helper-DlAUqK2U.js"])))=>i.map(i=>d[i]);
import{h as S,d as L,H as D}from"./index-CENpTiMW.js";import{_ as T}from"./iframe-Ba5HEGk7.js";import{d as $,s as p,v as b,k as E,p as C,o,b as i,t as R,f as j,F as H,m as O,q as P}from"./vue.esm-bundler-B7Tz_gfl.js";import{_ as A}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./decorators-Bnaor6Ku.js";const I=E(()=>T(()=>import("./NNotification-2j1akSL-.js"),__vite__mapDeps([0,1,2,3]),import.meta.url)),B=$({name:"NNotificationList",components:{NNotification:I},props:{url:{type:String,required:!0},method:{type:String,default:"get"},params:{type:Object,default:()=>({})},accessToken:{type:String,default:""}},setup(e){const d=p([]),s=p(!1),n=p(null);return b(async()=>{s.value=!0,n.value=null;const u={"Content-Type":"application/json"};e.accessToken&&(u.Authorization=`Bearer ${e.accessToken}`);const r={method:e.method.toUpperCase(),headers:u};e.method!=="get"&&(r.body=JSON.stringify(e.params));const a=e.method==="get"?`${e.url}?${new URLSearchParams(e.params).toString()}`:e.url;try{const t=await fetch(a,r);if(!t.ok)throw new Error(`HTTP error! status: ${t.status}`);const M=await t.json();d.value=M||[]}catch(t){n.value=t.message||"An error occurred"}finally{s.value=!1}}),{notifications:d,isLoading:s,error:n}}}),U={class:"n-notification-list"},q={key:0},F={key:1,class:"error"};function x(e,d,s,n,V,u){const r=C("n-notification");return o(),i("div",U,[e.isLoading?(o(),i("div",q,"Loading...")):e.error?(o(),i("div",F,R(e.error),1)):j("",!0),(o(!0),i(H,null,O(e.notifications,(a,t)=>(o(),P(r,{key:t,message:a.message,time:a.time,actionButtons:a.actionButtons},null,8,["message","time","actionButtons"]))),128))])}const z=A(B,[["render",x]]);B.__docgenInfo={displayName:"NNotificationList",exportName:"default",description:"",tags:{},props:[{name:"url",type:{name:"string"},required:!0},{name:"method",type:{name:"Method"},defaultValue:{func:!1,value:"'get'"}},{name:"params",type:{name:"Record<string, any>"},defaultValue:{func:!0,value:"() => ({})"}},{name:"accessToken",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["/home/runner/work/NovaUI/NovaUI/src/stories/NNotificationList/NNotificationList.vue"]};const Y={component:z,title:"Social/Notifications/NNotificationList"},c={args:{url:"/mock/data",method:"get",params:{}}},J=[{message:"Notification 1",time:"1 hour ago",actionButtons:[{label:"View",action:()=>console.log("View clicked")},{label:"Dismiss",action:()=>console.log("Dismiss clicked")}]},{message:"Notification 1",time:"1 hour ago",actionButtons:[{label:"View",action:()=>console.log("View clicked")},{label:"Dismiss",action:()=>console.log("Dismiss clicked")}]}],m={args:{url:"/mock/data",method:"get",params:{}},parameters:{msw:{handlers:[S.get("/mock/data",async()=>(await L(500),D.json(J)))]}}},l={args:{url:"/mock/data",method:"get",params:{}},parameters:{msw:{handlers:[S.get("/mock/data",async()=>(await L(500),new D(null,{status:403})))]}}};var f,g,h;c.parameters={...c.parameters,docs:{...(f=c.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    url: '/mock/data',
    method: 'get',
    params: {}
