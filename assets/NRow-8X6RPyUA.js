import{d as b,u as x,s as C,v as S,w as B,e as r,t as $,l as w,j as F,F as E,k as I,n as j,o as n,q,x as R}from"./vue.esm-bundler-BjHivwhV.js";import{_ as V}from"./_plugin-vue_export-helper-DlAUqK2U.js";const k=b({name:"NRow",props:{cols:{type:Object,required:!0},gap:{type:String,default:"1rem"},title:{type:String,default:""},subtitle:{type:String,default:""}},setup(e){const y=x(),s=C(`n-row-${Math.random().toString(36).substr(2,9)}`),i={sm:0,md:768,lg:1024,xl:1280},h=t=>t.endsWith("px")?parseFloat(t):t.endsWith("rem")||t.endsWith("em")?parseFloat(t)*16:16,u=()=>{const t=h(e.gap);let l=`
        .${s.value} {
          display: flex;
          flex-wrap: wrap;
          gap: ${e.gap};
